...
// frappe.query_reports["Customize Stock Balance"] = {
// 	"filters": [
    ...
    filters: [
        ...
        },
        {
            ...
            get_data: async function (txt) {
                ...
                // If item_group has values, apply "in" filter
                ...
                return (data || []).map(({ name, ...rest }) => {
                    return {
                        value: name,
                        description: Object.values(rest).join(", "),
                    };
                });
            },
        },
...
erpnext.utils.add_inventory_dimensions("Customize Stock Balance", 8);
